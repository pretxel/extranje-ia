# pricing-availability Specification

## Purpose
Controls whether paid plans are purchasable. Defines the "coming soon" presentation, the disabled/non-redirecting CTA behavior across all paid surfaces, and the single switch that toggles between coming-soon and live checkout.
